...
void loop()
{
  ...
  int newVolume = map(analogRead(PIN_VOLUME), 0, 1023, 0, 30);
  if (newVolume != volume) {
    volume = newVolume;
...
long getCurrentCard() {
  ...
  static long cardMappings[CARD_COUNT] = { -1, 1563555, 1465905, 1224405, 1500135, 1219575, 1238685,
                                           1134105, 1238895, 923335, 964033, 1684305, 994609, 829003,
                                           1004941, 885283, 962353
                                         };
